...
public class ValidatePHPTravelWedTitle {
    private static final Logger LOGGER = LogManager.getLogger(ValidatePHPTravelWedTitle.class);
    WebDriver driver;
    ...
    public void browserInitialization() {
        ...
        LOGGER.info("-------Start Test ValidatePHPTravelWedTitle ------- ");
    ...
    public void closeBrowser() {
        ...
        LOGGER.info("****End Test ValidatePHPTravelWedTitle**** ");
    }
}
